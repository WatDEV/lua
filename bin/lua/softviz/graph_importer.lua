...
local funcCallGraphOperator = require "luadb.operator.funcCallGraph_operator" --:::::::::::::::::::::::::::::::--
----------------------------------------------
...
local function extractEdge(v, existingedges, nodes, color) --:::::::::::::::::::::::::::::::--
...
local function doVisualMapping(nodes, minComplexity, maxComplexity, minLines, maxLines, modifNodes)
  local minSize = 8
  local maxSize = 100
  for k, n in pairs(nodes) do
    n.params.color = modifNodes[n.params.origId].color
...
local function extractGraph(absolutePath, graphPicker)
  ...
  for _, v in ipairs(luadbGraph.nodes) do
    --local color = luadbGraph.modified_nodes[v.id].color
  ...
  luadbGraph:Operator(funcCallGraphOperator.setEdgeColor) --:::::::::::::::::::::::::::::::--
  --luadbGraph:Operator(funcCallGraphOperator.filterEdges) --:::::::::::::::::::::::::::::::--
  
  for _, v in pairs(luadbGraph.modified_edges) do
    local color = v.color--luadbGraph.modified_edges[v.id].color --:::::::::::::::::::::::::::::::--
	extractEdge(v, existingedges, nodes, color)
  end
  luadbGraph:Operator(funcCallGraphOperator.setNodeColor) --:::::::::::::::::::::::::::::::--
  doVisualMapping(nodes, minComplexity, maxComplexity, minLines, maxLines, luadbGraph.modified_nodes)
end
